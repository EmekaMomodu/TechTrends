...
cur.execute("INSERT INTO posts (title, content) VALUES (?, ?)",
            ('2020 CNCF Annual Report',
             'The Cloud Native Computing Foundation (CNCF) annual report for 2020 is now available. The report '
             'highlights the growth of the community, events, projects, and more, over the past year.')
            )

cur.execute("INSERT INTO posts (title, content) VALUES (?, ?)",
            ('KubeCon + CloudNativeCon 2021',
             'The Cloud Native Computing Foundation flagship conference gathers leading technologists from leading '
             'open source and cloud native communities to further the education and advancement of cloud native '
             'computing.')
            )
...
cur.execute("INSERT INTO posts (title, content) VALUES (?, ?)",
            ('CNCF Cloud Native Interactive Landscape',
             'This landscape is intended as a map through the previously uncharted terrain of cloud native '
             'technologies. There are many routes to deploying a cloud native application, with CNCF Projects '
...
cur.execute("INSERT INTO posts (title, content) VALUES (?, ?)",
            ('CNCF Cloud Native Definition v1.0',
             ...
             'coupled systems that are resilient, manageable, and observable. Combined with robust automation, they '
             'allow engineers to make high-impact changes frequently and predictably with minimal toil.\nThe Cloud '
             'Native Computing Foundation seeks to drive adoption of this paradigm by fostering and sustaining an '
...
cur.execute("INSERT INTO posts (title, content) VALUES (?, ?)",
            ('Kubernetes Certification',
             'CNCF, along with the Linux Foundation, have created certification programs for Kubernetes as well as '
